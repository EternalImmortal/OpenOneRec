...
#RUN_SFT_SID2CAPTION=0
#RUN_SFT_RECO_REASON=0

# ============== Configuration ==============
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

INPUT_METADATA="../../raw_data/tme_data/onerec_bench_release.parquet"
PID2SID_MAPPING="../../raw_data/tme_data/tme_pid2sid_260123_12w.partuet"
#PRODUCT_PID2SID_MAPPING="../../raw_data/tme_data/product_pid2sid.parquet"
CAPTION_INPUT="../../raw_data/tme_data/tme_pid2caption_260123_12w.partuet"
OUTPUT_BASE_DIR="../../music_output"
...
if [ "${RUN_PRETRAIN_ITEM_UNDERSTAND}" = "1" ]; then
    ...
    run_task "pretrain" "item_understand" "${SCRIPT_DIR}/pretrain/item_understand_save_json.py" \
